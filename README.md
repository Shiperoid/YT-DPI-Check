...
1. Скачайте **`YT-DPI.bat`** и **`YT-DPI.ps1`** со [страницы релиза v2.3.3](https://github.com/Shiperoid/YT-DPI/releases/latest) и положите **в одну папку**.
...
1. Скачайте **`YT-DPI.sh`** со [страницы релиза v2.3.2](https://github.com/Shiperoid/YT-DPI/releases/latest) 
2. **Зависимости:**
