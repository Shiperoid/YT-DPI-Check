# YT-DPI
![GitHub Release](https://img.shields.io/badge/release-2.3.0-green)
...
* **Релиз:** [Releases](https://github.com/Shiperoid/YT-DPI/releases) — для Windows нужны **`YT-DPI.bat`** и **`YT-DPI.ps1`** в одной папке; см. [v2.3.0](https://github.com/Shiperoid/YT-DPI/releases/tag/2.3.0) (или последний тег).
...
1. Скачайте **`YT-DPI.bat`** и **`YT-DPI.ps1`** со [страницы релиза v2.3.0](https://github.com/Shiperoid/YT-DPI/releases/tag/2.3.0) (или последнего релиза) и положите **в одну папку**.
...
1. Скачайте **`YT-DPI.sh`** с той же [страницы релиза](https://github.com/Shiperoid/YT-DPI/releases/tag/2.3.0) (или последнего тега).
2. **Зависимости:**
...
8. **Запуск одной строкой (нужен Bash):** скачать скрипт с конкретного тега и сразу выполнить (подставьте нужный тег, например **2.3.0**):
   ```bash
   bash <(curl -Ls "https://raw.githubusercontent.com/Shiperoid/YT-DPI/2.3.0/YT-DPI.sh")
   ```
